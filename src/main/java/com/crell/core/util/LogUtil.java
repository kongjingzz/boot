...
public class LogUtil {
	 ...
	 * 打印日志
	 */
	private static Logger infolog = LoggerFactory.getLogger(LogType.EX_LOG);
...
//		log.setIpAddress(user.getIp());
		...
		cachedThreadPool.execute(new SaveLogRunnable(log));
	}
	...
	public class SaveLogRunnable implements Runnable{
		...
		public SaveLogRunnable(SystemLog log){
			super();
			this.log = log;
		}
